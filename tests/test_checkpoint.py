...
from vision_transformer.pl_modules.pl_module import LightningModel
from vision_transformer.run import run
...
class ModuleWithCustomCheckpoint(LightningModel):
